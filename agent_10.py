...
from landing_page_tools1 import deploy_site, TOOLS
...
def system_prompt():
    return """You are a marketing specialist and web designer who creates web landing pages
    ...
    and deploy with the deploy_site tool. Go!"""
